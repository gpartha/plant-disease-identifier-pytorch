"""Main training script for training sugarcane plant disease detection using Intel XPU."""
...
def main():
    ...
    Config.PLANT_NAME = "Sugarcane"
    Config.MODEL_NAME_TOSAVE = "SugarcaneDiseaseDetector"
    ...
    # Data preparation
    source_dir = "data/raw/sugarcane_images"  # Your single directory
    output_dir = "data/processed/sugarcane"
